...
type RequestBodyToFrameV2ContextOptions = {
  secret?: FrogConstructorParameters['secret']
}

type RequestBodyToFrameV2ContextReturnType<
  env extends Env = Env,
...
export async function requestBodyToFrameV2Context<
  env extends Env,
  path extends string,
  input extends Input,
  //
...
>(
  ...
  { secret }: RequestBodyToFrameV2ContextOptions,
): Promise<RequestBodyToFrameV2ContextReturnType<env, path, input, _state>> {
