...
export const app = new Frog({ title: 'Frog Frame' }) // [!code focus]
...
You can pass optional [constructor parameters](/reference/frog#constructor-parameters) to `new Frog({ title: 'Frog Frame' }){:js}` to:
