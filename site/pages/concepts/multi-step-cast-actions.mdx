...
Multi-step Cast Actions are similar to [Cast Actions](/cast-actions) with a difference that they return a frame, instead of showing a message. (see the [spec](https://warpcast.notion.site/Frames-Multi-step-actions-f469054de8fb4ffc8b8e2649a41b6ad9)).
